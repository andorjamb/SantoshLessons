...
const fakeFetch = (endpoint) => {
    return new Promise((resolve, reject) => {
        ...
        setTimeout(() => {  //this is just here for simulation value, returns object value after a random amount of wait time
...
const logFlightStatus = () => {
    (fakeFetch('flight-status')).then((dataToResolve) => { console.log(dataToResolve) }); //the parameter could be anything, it just represents the value of the object that is fetched by the function in the fakeFetch function when it is resolved
